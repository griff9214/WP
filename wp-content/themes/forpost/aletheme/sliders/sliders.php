...
class Aletheme_Sliders
{
    ...
    public static function getShortcodeScript()
    {
        echo SELF::$slider_script;
    }
    ...
    public function shortcodeSliderInit($atts)
    {
        ...
        SELF::$slider_script = "<script>$(document).ready(function () {
        $('." . $slider['slug'] . "').slick({
            autoplay: true,
            autoplaySpeed: 4000,
            dots: true,
            ...
            foreach ($news as $post) {
                ...
                $content .= '
                    <div class="review ourReviews__review">
                        <div class="review__caption"><div class="review__firm">' . ale_get_meta("otziv_company", true, $post->ID) . '</div>
                        <div class="review__text">' . get_the_content() . '</div>
                        <img src="' . ale_get_meta("otziv_company_logo", true, $post->ID) . '" alt="" class="review__firmLogo">
                    </div>
                    <div class="review__author">' . ale_get_meta("otziv_author", true, $post->ID) . '</div>
                </div>';
            }
            wp_reset_postdata();
            $content .= '</div>';
        ...
        */
        ...
        {
        echo '<a href="#TB_inline?width=640&height=600&inlineId=aletheme-slider-editor-shortcode-wrap" class="thickbox"
                 title="' . __('Insert Slider', 'aletheme') . '" data-page="' . $page . '"
                 data-target="' . $target . '"><img src="' . ALETHEME_URL . '/assets/images/aletheme_icon_16.png"
                                                    alt="Insert Slider"/></a>';
        }
