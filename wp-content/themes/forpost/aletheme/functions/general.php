...
function get_breadcrumbs()
{
    ...
    $show_on_home = 0;
    $show_home_link = 1;
    $breadcrumb_home_link = 0;
    $show_title = 1;
    $delimiter = '';
    $before = '<li class="breadcrumbs__item"><span>';
    $after = '</span></li>';

    global $post;
    $home_link = home_url('');
    $link_before = '<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" class="breadcrumbs__item" >';
    $link_after = '</li>';
    $link_inner_start = '<span itemprop="name">';
    $link_inner_end = '</span>';
    $link_attr = ' itemscope itemtype="http://schema.org/Thing" itemprop="item" class="breadcrumbs__link"';
    $link = $link_before . '<a' . $link_attr . ' href="%1$s">' . $link_inner_start . '%2$s' . $link_inner_end . '</a>' . $link_after;
    ...
    if (is_home() || is_front_page()) {
        ...
        if ($show_on_home == 1) {
            echo '<ul class="breadcrumbs" itemscope itemtype="https://schema.org/BreadcrumbList"><a href="' . $home_link . '">' . $text['home'] . '</a></ul>';
        }
        ...
        if ($show_home_link == 1) {
            if ($breadcrumb_home_link == 0) {
                echo '<li class="breadcrumbs__item" ><a class="breadcrumbs__link" href="' . $home_link . '">' . $text['home'] . '</a></li>';
            } else {
